...
namespace md2visio.struc.figure
{
    internal class MmdJsonObj : ValueAccessor
    {
        ...
        public MmdJsonObj Load(string text, int depth = 0)
        {
            data.Clear();
            return Load(new StringBuilder(text), depth);
        }
